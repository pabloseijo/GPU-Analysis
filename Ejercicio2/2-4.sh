...
#SBATCH -o vectorAdd-Ej4-output.txt  # Archivo de salida
...
REPS=10                # Número de repeticiones del lazo
...
echo "Ejecución completada. Revisa vectorAdd-Ej4-output.txt para los resultados."
